                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        onTap: () {
                          showCountryPicker(
                            ...
                            countryListTheme: CountryListThemeData(
                              flagSize: 25,
                              backgroundColor: kDynamicModalBackground(Get.context!),
                              textStyle: TextStyle(color: kDynamicText(Get.context!)),
                              borderRadius: const BorderRadius.only(
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          color: kDynamicPrimary(Get.context!)!.withOpacity(0.08),
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: kDynamicPrimary(Get.context!)!.withOpacity(0.2),
                          ),
                        ),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            8.height,
                            MyText(
                              text: 'We will send a verification code to this number for security purposes.',
                              color: kDynamicText(Get.context!)!.withOpacity(0.7),
                              size: 12,
                            ),
                          ],
                        ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: MyButton(
                        onTap: phoneController.text.isEmpty ? null : () {
                          Get.back();
                          onUpdate(phoneController.text, selectedCountryCode.value);
                        },
                        buttonText: 'Update',
                      ),
                    ),
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        ...
                                        width: selectedGender.value == gender ? 2 : 1,
                                      ),
                                    ),
                                    child: Row(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: MyButton(
                        onTap: selectedGender.value.isEmpty ? null : () {
                          Get.back();
